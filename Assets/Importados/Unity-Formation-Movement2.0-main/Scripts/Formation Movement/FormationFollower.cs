...
namespace Goodgulf.Formation
{
    ...
    public class FormationFollower : FormationBase
    {
        ...
        public void MoveToGridPoint (float rotationZ)
        {
        ...
        public void MoveTowardsGridPoint()
        {
            if (formationGridPoint != null)
            {
                ...
                RaycastHit hit;
                if (Physics.Raycast(rayPosition, Vector3.forward, out hit, Mathf.Infinity, formation.layerMaskTerrainAndObstacles))
                { 
